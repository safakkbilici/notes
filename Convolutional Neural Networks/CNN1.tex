...
\begin{document}
\title{\centerline{\rule{15cm}{2pt}} \textbf{An Overview Of Convolutional Neural Networks}\\\centerline{\rule{15cm}{0.4pt}}}
\author{
  BILICI, M. Şafak\\
...
\tableofcontents
\begin{abstract}
\textbf{In this overview paper, we will discuss a kind of neural network that is called Convolutional Neural Networks, such that they are generally used in Image Recognition tasks. This paper focuses on theoretical foundations of Convolutional Neural Networks and some of Deep Learning methods that can be used in Convolutional Neural Networks. Also a practical Image Recognition application will be discussed in section 11.}
\end{abstract}
...
\begin{figure}[H]
    \centering
    \subfloat[Input and Convolved Image]{{\includegraphics[width=9cm]{relufm.jpg} }}%
    \qquad
